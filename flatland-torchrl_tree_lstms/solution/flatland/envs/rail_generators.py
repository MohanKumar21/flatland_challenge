...
class SparseRailGen(RailGen):
    ...
    def __init__(self, max_num_cities: int = 2, grid_mode: bool = False, max_rails_between_cities: int = 2,
                 max_rail_pairs_in_city: int = 2, seed=None,city_positions=None,platforms=None) -> RailGenerator:
        """
    ...
    def generate(self, width: int, height: int, num_agents: int, num_resets: int = 0,
                 np_random: RandomState = None,city_positions=None) -> RailGenerator:
        """
        ...
        self.city_radiuses=np.zeros(max_feasible_cities)
        ...
        # print(outer_connection_points,self.city_positions,'sawdz')
        ...
        return grid_map, {'agents_hints': {
            ...
            'city_platforms': {city_positions[i]:[False for j in range(1,int(np.random.uniform(1,10)))] for i in range(len(city_positions))},
    ...
    def _generate_random_city_positions(self, num_cities: int, city_radius: int, width: int,
        ...
        for _ in range(num_cities):
            ...
            if self.city_positions is not None:
                row=int(self.city_positions[_][0])
                col=int(self.city_positions[_][1])
    ...
    def _generate_city_connection_points(self, city_positions: IntVector2DArray, city_radius: int,
        ...
        for (i,city_position) in enumerate(city_positions):
            ...
            if self.grid_mode:
                ...
                # print(current_closest_direction)
            ...
            # print(connections_per_direction)
    ...
    def _connect_cities(self, city_positions: IntVector2DArray, connection_points: List[List[List[IntVector2D]]],
        ...
        # x_coords=np.array([i[1] for i in all_paths])
        # y_coords=np.array([70-i[0] for i in all_paths])
