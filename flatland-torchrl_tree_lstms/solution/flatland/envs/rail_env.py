...
class RailEnv(Environment):
    ...
    def __init__(self,
        ...
        # rostoki 
        self.signals=np.random.randint(0,2,(self.width,self.height))
    ...
    def reset(self, regenerate_rail: bool = True, regenerate_schedule: bool = True, *,
        ...
        self.city_positions=optionals['agents_hints']['city_positions']
        self.city_platforms=optionals['agents_hints']['city_platforms']
        # if optionals and 'city_platforms' in optionals:
        #     self.city_positions=optionals['city_positions']
        #     self.city_platforms=optionals['city_platforms']
    ...
    def preprocess_action(self, action, agent):
        ...
        # rostoki 
        # if self.signals[agent.position]==0:
    ...
    def step(self, action_dict_: Dict[int, RailEnvActions]):
        ...
        for agent in self.agents:
            ...
            # Rostoki 
            # if (agent_transition_data['position'] in self.city_platforms.keys()):
            #     platforms=self.city_platforms[agent_transition_data['position']] 
            #     added_train=False
            ...
            #     if added_train:
            #         movement_allowed=False 
            #     self.city_platforms[agent_transition_data['position']]=platforms 
