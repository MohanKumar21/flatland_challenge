...
def get_args():
    ...
    parser.add_argument("--save-video", "-s", default="./solution/video.mp4", help="path to save video")
...
if __name__ == "__main__":
    ...
    while True and iter<400:
        ...
        import PIL 
        frames_list.append(PIL.Image.fromarray(frame))
    ...
    frames_list[0].save(f"flatland_tree_lstm_agent_more_rails_80x80_3_agents_with_platforms.gif", save_all=True, append_images=frames_list[1:], duration=15, loop=0)# print(pd.DataFrame(action_history).sum(axis = 0))
