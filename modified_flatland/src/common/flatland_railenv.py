    ...
    def _launch(self, env_params, observation):
        env=RailEnv(
            ...
            rail_generator=sparse_rail_generator(
                ...
                city_positions=env_params.city_positions,
            platforms=env_params.platforms
            ),
            # schedule_generator=sparse_schedule_generator(env_params.speed_profiles),
            # line_generator=sparse_line_generator(env_params.speed_profiles,env_params.seed,env_params.agent_positions,env_params.agent_targets),
